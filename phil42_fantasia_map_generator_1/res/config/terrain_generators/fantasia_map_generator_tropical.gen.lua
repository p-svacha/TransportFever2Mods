...
local temperateassetsgen = require "terrain/fmg_tropicalassetsgen"
...
return {
	...
	updateFn = function(params)
		...
		local riverWidthParam = params.riverWidth
		...
		local chosenStartWidth = math.random(minStartWidth, maxStartWidth)

		local minEndWidth = 20
		local maxEndWidth = 45
		local chosenEndWidth = math.random(minEndWidth, maxEndWidth)

		local widthModifierFromParam = ((riverWidthParam + 1) / 4)
		if widthModifierFromParam > 1 then
			widthModifierFromParam = widthModifierFromParam * 1.3
		end
		chosenStartWidth = chosenStartWidth * widthModifierFromParam
		chosenEndWidth = chosenEndWidth * widthModifierFromParam
		...
		for i = 1, numRivers do
			...
			local riverConfig = {
				...
				baseProbability = 0.5,
				minDist = 0,
				startWidth = chosenStartWidth,
				endWidth = chosenEndWidth,
