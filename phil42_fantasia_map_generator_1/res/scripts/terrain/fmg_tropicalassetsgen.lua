...
data.Make = function(layers, config, mkTemp, heightMap, ridgesMap, distanceMap)
	...
	for i = 1, numForestLayers do
		local forestAmount = math.random(minForestSize, maxForestSize) / 97
		local forestsSize = math.random(550, 2300)
	...
	layers:Map(map_coastal_forest, map_coastal_forest, {0, 1}, {0, palm}, true)
