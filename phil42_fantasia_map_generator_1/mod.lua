...
return {
	info = {
		...
		tags = { "Terrain", "Generation", "Temperate", "Hills", "Mountains", "Random", "Rivers", "Lakes", "Misc", "Script Mod", "Peaks", "Variety", "Fantasy", "Challenge", "Canyon", "Mesa", "Dry", "Tropical", "Climate", "Environment" },
		authors = {
			{
				name = "Phil42",
				role = 'CREATOR',
